...
public class BasicAPIMultipleResultExtract extends BasicAPITestSuiteBase{
	...
	@Test(dataProvider="BasicAPIMultipleResultExtractData")
	public void BasicAPIMultipleResultExtractTest(String API,String APIName,String success,String scheme,
		...
		String res =given().relaxedHTTPSValidation().expect().when().get(API)
	      .then().extract().asString();
		JsonPath jsonpath = new JsonPath(res);
		int ActualResult = 1;//jsonpath.getInt("settings.success"); 
		Error = jsonpath.getString("scheme");
		
		Scheme = jsonpath.getString("scheme");
		Number_length = jsonpath.getString("number.length");
		Number_prefix = jsonpath.getString("number.prefix");
		Type = jsonpath.getString("type");
		Brand = jsonpath.getString("brand");
		Prepaid = jsonpath.getString("prepaid");
		Bank_name = jsonpath.getString("bank.name");
		Bank_logo = jsonpath.getString("bank.logo");
		Bank_url = jsonpath.getString("bank.url");
		Bank_city = jsonpath.getString("bank.city");
	...
	@DataProvider
	public Object[][] BasicAPIMultipleResultExtractData(){
