...
public class BasicUIAutoTestSuiteCaseM extends BasicUIAutoTestSuiteBase{
	...
	@Test(dataProvider="BasicUIAutoTestSuiteCaseMData", priority = 2)
	public void BasicUIAutoTestSuiteCaseMTest(String Keyword,String Object,String ObjectType,String Value,String RunTime) throws Exception{
		DataSet++;		
	...
	@DataProvider
	public Object[][] BasicUIAutoTestSuiteCaseMData(){
